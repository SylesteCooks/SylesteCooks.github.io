var init = function (window) {
    ...
    window.opspark.makeGame = function() {
        ...
        // TODO 1 : Declare and initialize our variables
            var circle;
            var circles = []; //variables declared to draw and hold data for the circles

        // TODO 2 : Create a function that draws a circle 
            function drawCircle (){
                circle = draw.randomCircleInArea(canvas, true, true, "#999", 2);// draws a random circle
                physikz.addRandomVelocity(circle, canvas, 5, 5);// randomizes the velocity of said circle
                view.addChild(circle);// adds the circle to view
                circles.push(circle);// stores all information about the circle in the circles array
            }
